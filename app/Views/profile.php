...
<?=$this->section('main-content') ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-8 offset-sm-2 col-md-4 offset-md-4 mt-5 pt-3 pb-3 bg-light text-wrap rounded ">
                <div class="container">
                    <h3 class="p-3 bg-warning rounded">Welcome, <br>
                        <?php echo session()->get('firstname') . ' ' . session()->get('lastname') ?></h3>
                    <hr><!-- horizontal line not working -->
