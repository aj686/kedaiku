    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <h3><a href="/gambar" class="btn btn-sm btn-primary">Back</a>   Kemaskini Pelajar</h3>
                <hr>
                ...
                <?php echo form_open_multipart('/gambar/edit/' . $gambar['id']); ?>
                    ...
                    <div class="form-group row mt-2">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="tingkatan" name="tingkatan" value="<?= $gambar['tingkatan'] ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mt-2">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="kelas" name="kelas" value="<?= $gambar['kelas'] ?>">
                      </div>
                    </div>
